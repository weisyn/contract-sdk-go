...
// Package main 提供音乐作品NFT合约示例
//
// 📋 示例说明
//
// 本示例展示如何使用 WES Contract SDK Go 构建音乐作品NFT合约。
// 通过本示例，您可以学习：
...
//	  "track_name": "Sunset Over Mountains", // 艺术品名称（必填）
//	  "artist": "Alice",               // 艺术家名称（必填）
...
//       "to": "<接收者地址>",
//       "token_id": "art_001",
//       "track_name": "Sunset Over Mountains",
//       "artist": "Alice"
//     }
//
//export MintNFT
func MintNFT() uint32 {
	...
	track_nameStr := params.ParseJSON("track_name")
	artistStr := params.ParseJSON("artist")

	if toStr == "" || tokenIDStr == "" || track_nameStr == "" || artistStr == "" {
	...
	event.AddStringField("track_name", track_nameStr)
	event.AddStringField("artist", artistStr)
	if descriptionStr != "" {
