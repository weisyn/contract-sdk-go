...
// Package main 提供游戏货币合约示例
//
// 📋 示例说明
//
// 本示例展示如何使用 WES Contract SDK Go 构建游戏货币合约。
// 游戏货币是一种专门用于游戏内交易的代币，支持游戏内购买、奖励发放等场景。
// 通过本示例，您可以学习：
//   - 如何使用 helpers/token 模块进行代币操作
//   - 如何使用业务语义API简化合约开发
//   - 如何实现游戏货币的核心功能（Transfer、Mint、Burn、Approve、Airdrop）
//
// 🎯 核心功能
//
//  1. Transfer - 转账
...
// GameCurrencyContract 游戏货币合约
//
// 本合约使用 helpers/token 模块提供的业务语义API，
// 简化游戏货币操作的实现，开发者只需关注业务逻辑。
//
// 游戏货币特点：
//   - 游戏内交易
//   - 奖励发放
//   - 道具购买
type GameCurrencyContract struct {
...
func Initialize() uint32 {
	...
	event.AddStringField("contract", "GameCurrency")
