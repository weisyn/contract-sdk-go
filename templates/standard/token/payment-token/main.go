...
// Package main 提供支付代币合约示例
//
// 📋 示例说明
//
// 本示例展示如何使用 WES Contract SDK Go 构建支付代币合约。
// 支付代币是一种专门用于支付的代币，具有快速转账、低手续费等特点。
// 通过本示例，您可以学习：
//   - 如何使用 helpers/token 模块进行代币操作
//   - 如何使用业务语义API简化合约开发
//   - 如何实现支付代币的核心功能（Transfer、Mint、Burn、Approve、Airdrop）
//
// 🎯 核心功能
//
//  1. Transfer - 转账
...
// PaymentTokenContract 支付代币合约
//
// 本合约使用 helpers/token 模块提供的业务语义API，
// 简化支付代币操作的实现，开发者只需关注业务逻辑。
//
// 支付代币特点：
//   - 快速转账
//   - 低手续费
...
func Initialize() uint32 {
	...
	event.AddStringField("contract", "PaymentToken")
