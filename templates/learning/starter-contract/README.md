...
**路径**：`contracts/templates/learning/starter-contract/`

**目的**：这是一个**学习模板**，提供空白但结构完整的合约骨架，帮助开发者从零开始构建自定义合约。

**与其他目录的关系**：
- `contracts/templates/learning/starter-contract/`：**学习模板**，侧重教学，可复制后修改
- `contracts/templates/standard/`：**标准模板**，生产级骨架
- `contracts/examples/`：**资源级示例**，固定行为，测试完备
