...
**路径**：`contracts/templates/learning/basic-nft/`

**目的**：这是一个**学习模板**，提供大量注释和教学说明，帮助开发者理解 NFT 合约的基础概念。

**与其他目录的关系**：
- `contracts/templates/learning/basic-nft/`：**学习模板**，侧重教学，可复制后修改
- `contracts/templates/standard/nft/`：**标准 NFT 模板**，生产级完整实现
- `contracts/examples/`：**资源级示例**（未来可添加 NFT 示例）
